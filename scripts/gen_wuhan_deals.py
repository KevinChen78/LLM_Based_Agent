...
TEMPLATES = [
    ...
    # Phase 3-B 召回缺口补齐:西式快餐(只增不改既有模板,id 区间不变)。
    # category 用既有「西餐」,汉堡/披萨/炸鸡走 tags 供文本检索命中。
    ("西餐", "汉堡薯条拼盘（{p} 人餐）", ["汉堡", "薯条", "西式快餐"], 68, 1, 3, "双层牛肉汉堡配薯条，快餐性价比之选"),
    ("西餐", "披萨炸鸡双人餐", ["披萨", "炸鸡", "西式快餐"], 98, 2, 3, "9 寸披萨配脆皮炸鸡，聚会快餐组合"),
    ("西餐", "西式简餐（{p} 人餐）", ["汉堡", "意面", "西式快餐"], 88, 1, 2, "汉堡意面随心配，工作日午餐优选"),
]
